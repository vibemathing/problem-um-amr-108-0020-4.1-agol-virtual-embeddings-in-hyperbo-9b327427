...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/AMR-108-0020"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-v1",
      "problem_contract_sha256": "82284ef0b14bf28b9becc472600fb185e79f9986230e2f1cd0537bc4a954aa6f",
      "problem_id": "problem:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427",
      "route_id": "route:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-source-fidelity-01",
      "graph_id": "graph:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Do closed hyperbolic $3$-manifold groups have finite-index subgroups that embed in a word-hyperbolic reflection group?"
          },
          "statement_sha256": "6fca470c8b56d1de4b51dff14175f85b830df73e5c75436667afc05f72bf645d"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-root",
      "route_id": "route:um-amr-108-0020-4.1-agol-virtual-embeddings-in-hyperbo-9b327427-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-amr-108-0020-5249fd316c82",
        "url": "https://www.unsolvedmath.com/problems/AMR-108-0020"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
